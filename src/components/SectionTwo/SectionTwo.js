            ...
            <div className="mt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    ...
                    <div className="relative flex items-center justify-between">
                        <img src="/images/ultra_light.png" alt="ultra light" className="object-cover w-full md:h-[660px] xs:h-[460px] h-[460px]" />
                    ...
                    <div className="relative flex items-center justify-between">
                        <img src="/images/best_resolution.png" alt="best resolution" className="object-cover w-full md:h-[660px] xs:h-[460px] h-[460px]" />
